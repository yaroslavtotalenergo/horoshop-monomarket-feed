...
// ── Демо: Ідеальні описи для 3 товарів ────────────────────────────
function getCustomDescription(vendorCode) {
  const customDescriptions = {
    'BPC123047002': `
<h5>Розумне заряджання для ваших батарей</h5>
<br>
<p>Victron Energy Blue Smart IP22 Charger — це професійний інтелектуальний зарядний пристрій з підтримкою Bluetooth. Завдяки струму до 30А ваші акумулятори заряджаються максимально швидко та безпечно.</p>
<br>
<h5>Керування зі смартфона</h5>
<br>
<p>Вбудований модуль Bluetooth дозволяє контролювати стан батареї та налаштовувати параметри заряду прямо з вашого смартфона через безкоштовний додаток VictronConnect.</p>
<br>
<h5>Надійність та ефективність</h5>
<br>
<p>Пристрій має високу ефективність (до 94%) та виділяє мінімум тепла, що гарантує довговічну та стабільну роботу в будь-яких умовах.</p>
    `.trim(),
    'BPC122042002': `
<h5>Компактність та потужність</h5>
<br>
<p>Зарядний пристрій Blue Smart IP22 Charger від Victron Energy забезпечує зарядний струм до 20А. Ідеальне рішення для підтримки 12В акумуляторів у бездоганному стані.</p>
<br>
<h5>Сучасні технології контролю</h5>
<br>
<p>Використовуйте додаток VictronConnect для моніторингу напруги та струму заряду в реальному часі. Ваш смартфон перетворюється на повноцінний пульт керування батареєю.</p>
    `.trim(),
    'BPC121542002': `
<h5>Безпека та довговічність акумуляторів</h5>
<br>
<p>Інтелектуальний алгоритм заряду Blue Smart IP22 Charger (15А) дбайливо відновлює розряджені батареї та подовжує термін їхньої служби. Підходить для більшості типів 12В свинцево-кислотних та літієвих акумуляторів.</p>
<br>
<h5>Віддалений моніторинг</h5>
<br>
<p>Завдяки Bluetooth ви завжди знатимете, на якому етапі знаходиться зарядка. Налаштування режимів ще ніколи не було таким простим і наочним.</p>
    `.trim()
  };
  return customDescriptions[vendorCode] || null;
}
...
function transformOffer(offer) {
  ...
  return {
    ...
    description: getCustomDescription(vendorCode) || description,
    pictures,
    params,
